...
- **🔒 [INTERNO-costes-y-gestion.md](./INTERNO-costes-y-gestion.md)** — **NO enviar al cliente**. Costes reales de servicios, márgenes, qué cobrar y cómo gestionarlo (uso propio).

> Documentos para el cliente: **Propuesta** + **Presupuesto**. El archivo **INTERNO** es solo tuyo. Ajusta precios antes de enviar.
