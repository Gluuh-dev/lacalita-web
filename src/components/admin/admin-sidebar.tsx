...
import {LayoutDashboard, Image as ImageIcon, Images, UtensilsCrossed, LayoutGrid, BookOpen, Calendar, FileText, Settings, LogOut, Menu, ExternalLink, Sandwich, Star} from 'lucide-react';
