    ...
    <>
      ...
      <nav className="fixed inset-x-0 bottom-0 z-40 overflow-visible md:hidden">
        ...
        <button
          ...
          aria-label="Cartas"
          aria-expanded={open}
          className="absolute left-1/2 top-[32px] z-50 flex size-[62px] -translate-x-1/2 -translate-y-1/2 items-center justify-center rounded-full border-[3px] border-brand bg-bg text-ink shadow-[0_6px_16px_-4px_rgba(0,0,0,.3)] transition active:scale-95"
        >
