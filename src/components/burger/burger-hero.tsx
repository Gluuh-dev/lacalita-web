...
const BURGER_MEDIA_STYLE = {height: '92svh', maxWidth: '116%', objectFit: 'contain' as const, zIndex: 2, WebkitMaskImage: 'radial-gradient(ellipse 96% 97% at 50% 50%, #000 90%, transparent 100%)', maskImage: 'radial-gradient(ellipse 96% 97% at 50% 50%, #000 90%, transparent 100%)'};
